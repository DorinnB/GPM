    ...
    <div class="col-md-12" style="height:100%">
      <div class="row" style="height:5%;margin-top:10px;">
        ...
        <div id="" class="col-md-1" style="height:100%;">
          <a href="index.php?page=purchases" title="Purchases" class="btn disabled btn-link  btn-lg" style="width:100%; height:100%; padding:0px; border-radius:10px;">
        ...
        <div id="" class="col-md-1" style="height:100%;">
          <a href="controller/createInvoicablePayables-controller.php?dateStart=<?= $_GET['dateStartPurchase'] ?>" title="Accounting Files" class="btn btn-default btn-lg" style="width:100%; height:100%; padding:0px; border-radius:10px;">
