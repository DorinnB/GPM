...
If ($split['test_type_abbr']=="Str" AND $type=="Report")	{
  ...
  foreach ($ep as $key => $value) {
    ...
    if ($value['Cycle_min']>0) {
      $pvEssais->getRowDimension(51)->setVisible(TRUE);
    }
...
ElseIf (($split['test_type_abbr']=="Loa" OR $split['test_type_abbr']=="LoS" OR $split['test_type_abbr']=="Dwl" OR $split['test_type_abbr']=="Flx" OR $split['test_type_abbr']=="IRlx" OR $split['test_type_abbr']=="Te") AND $type=="Report")	{
