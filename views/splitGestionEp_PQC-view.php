                    ...
                    <form class="form-horizontal" style="height:100%;" id="update_Aux">
                      <div class="col-md-8">
                        ...
                        <div class="form-group">
                          <label class="control-label col-sm-2" for="val_1">Val&nbsp;1&nbsp;:</label>
                          <div class="col-sm-4">
                          ...
                          <label class="control-label col-sm-2" for="val_2">Val&nbsp;2&nbsp;:</label>
                          <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          <label class="control-label col-sm-2" for="val_3">Val&nbsp;3&nbsp;:</label>
                          <div class="col-sm-4">
                          ...
                          <label class="control-label col-sm-2" for="val_4">Val&nbsp;4&nbsp;:</label>
                          <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          <label class="control-label col-sm-2" for="val_5">Val&nbsp;5&nbsp;:</label>
                          <div class="col-sm-4">
                          ...
                          <label class="control-label col-sm-2" for="val_6">Val&nbsp;6&nbsp;:</label>
                          <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          <label class="control-label col-sm-2" for="val_7">Val&nbsp;7&nbsp;:</label>
                          <div class="col-sm-4">
                          ...
                          <label class="control-label col-sm-2" for="val_8">Val&nbsp;8&nbsp;:</label>
                          <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          <label class="control-label col-sm-2" for="val_9">Val&nbsp;9&nbsp;:</label>
                          <div class="col-sm-4">
                            <input type="text" class="MaJ form-control input-sm <?= ($eprouvette['val_9']=="")?'newval':'' ?>" name="val_9" id="val_9" value="<?= $eprouvette['val_9'] ?>" <?= ($eprouvette['d_checked']>0)?"disabled":""  ?>>
                          </div>

                          <label class="control-label col-sm-2" for="val_10">Val&nbsp;10&nbsp;:</label>
                          <div class="col-sm-4">
                            <input type="text" class="MaJ form-control input-sm <?= ($eprouvette['val_10']=="")?'newval':'' ?>" name="val_10" id="val_10" value="<?= $eprouvette['val_10'] ?>" <?= ($eprouvette['d_checked']>0)?"disabled":""  ?>>
                          </div>
                        </div>
                      </div>
