<div class="row" style="height:100%;">
  ...
  <div id="RH" class="col-md-2" style="height:100%; color: white; border-right: 1px solid white;">HR
    ...
    <a href="index.php?page=planningManagers" class="btn btn-default" style="width:100%; margin: 5px 0px; padding:0px; border-radius:10px;" role="button"><img src="img/calendar_yes.png" style="height:40px;"> Planning M.</a>
  ...
  <div id="Procurement" class="col-md-2" style="height:100%; color: white; border-right: 1px solid white;">Procurement
    ...
    <a href="index.php?page=payables" class="btn btn-default" style="width:100%; margin: 5px 0px; padding:0px; border-radius:10px;" role="button"><img src="img/payable.png" style="height:40px;" > Payables</a>
  </div>

  <div id="CRM" class="col-md-2" style="height:100%; color: white; border-right: 1px solid white;">CRM
    <a  href="index.php?page=payables" class="btn btn-info" style="width:100%; margin: 5px 0px; padding:0px; border-radius:10px;"role="button"><img src="img/payable.png" style="height:40px;" alt="Payables"> Payables</a>
    <a  href="index.php?page=invoices" class="btn btn-info" style="width:100%; margin: 5px 0px; padding:0px; border-radius:10px;"role="button"><img src="img/invoice.png" style="height:40px;" alt="Invoices"> Invoices</a>
    <div style="width:100;height:20px;"></div>
    <a  href="index.php?page=quotations" class="btn btn-default" style="width:100%; margin: 5px 0px; padding:0px; border-radius:10px;"role="button"><img src="img/quotation.png" style="height:40px;" alt="Quotations"> Quotations</a>
    ...
    <a  href="index.php?page=IT&tool=contacts" class="btn btn-primary" style="width:100%; margin: 5px 0px; padding:0px; border-radius:10px;"role="button"><img src="img/contact.png" style="height:40px;" alt="Contacts"> Contacts</a>
    <a  href="index.php?page=IT&tool=entreprises" class="btn btn-primary" style="width:100%; margin: 5px 0px; padding:0px; border-radius:10px;"role="button"><img src="img/companie.png" style="height:40px;" alt="Companies"> Companies</a>
  </div>
