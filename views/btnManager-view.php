<div class="row" style="height:100%;">
  ...
  <div id="Administrative" class="col-md-2" style="height:100%; color: white; border-right: 1px solid white;">Administrative
    ...
    <a  href="index.php?page=quotations" class="btn btn-por" style="width:100%; margin: 5px 0px; padding:0px; border-radius:10px;"role="button"><img src="img/quotation.png" style="height:40px;" alt="Quotations"> Quotations</a>
    ...
    <a  href="index.php?page=KPI" class="btn btn-default" style="width:100%; margin: 5px 0px; padding:0px; border-radius:10px;"role="button"><img src="img/statement.png" style="height:40px;" alt="Monthly Statement"> KPI</a>
    <div style="width:100;height:20px;"></div>
