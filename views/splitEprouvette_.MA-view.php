  ...
  <table id="table_ep" data-idJob="<?php echo $split['id_tbljob'];	?>" class="table table-striped table-condensed table-hover table-bordered" cellspacing="0" width="100%"  style="height:100%; white-space:nowrap;">
    <thead>
      <tr>
        ...
        <th>ID</th>
        <th>Dwg</th>
        <th><acronym title="Inertial Welding">I.W.</acronym></th>
    ...
    <tbody>
      <?php for($k=0;$k < count($ep);$k++): ?>
        <tr class="chartTR <?= (isset($ep[$k]['priority']) and $ep[$k]['priority']==0)?"priority0":"" ?> <?= (isset($ep[$k]['valid']) and $ep[$k]['valid']==0)?"void":"" ?>">
          ...
          <td class="IQC" data-value="<?= intval($ep[$k]['c_type_1_val']) ?>" <?= $epHisto2[$k]['c_type_1_val'] ?>><?= ($ep[$k]['c_type_1_val']>0)?intval($ep[$k]['c_type_1_val']):'' ?></td>
